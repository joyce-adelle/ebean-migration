...
alter table sheet_music_key_signatures add constraint fk_sheet_music_key_signatures_sheet_music_id foreign key (sheet_music_id) references sheet-music (id) on delete restrict on update restrict;
